...
//            {
//                ////Tổng ngày hôm nay
//                //ticketPriceinDate.Add(db.DailyLists.Where(x => x.Ticket.Department.Name == item).Sum(x => x.Total));
...
//            IList<StatisticTicket> sta = new List<StatisticTicket>();


//            ViewBag.ticketCountinMonth = ticketCountinMonth;
//            ViewBag.month = "Tháng "+ DateTime.Today.Month.ToString();
//            ViewBag.deparmentName = dep;
//            ViewBag.ticketPriceinMonth = ticketPriceinMonth;
